...
def create_datasets(
    ...
    def create_dataset(molecules, logps):
        dataset = []
    ...
    dataset_train = create_dataset(training_set_molecules, training_set_logps)
    dataset_test = create_dataset(test_set_molecules, test_set_logps)
